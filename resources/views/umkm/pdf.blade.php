...
<table width="100%" style="border-collapse: collapse; border: 1px solid black; padding:20px; font-size: 10px;">
	<tr style="border: 1px solid black;">
		<th style="text-align: center; width:20px; border: 1px solid black;">NO</th>
		<th style="text-align: center;border: 1px solid black;">NAMA LAPAK</th>
		<th style="border: 1px solid black; text-align: center;">KATEGORI</th>
		<th style="border: 1px solid black; text-align: center;">STATUS</th>
		<th style="border: 1px solid black; text-align: center;">ADDRESS</th>
		<th style="border: 1px solid black; text-align: center;">OPEN TIME</th>
		<th style="border: 1px solid black; text-align: center;">CLOSE TIME</th>
		<th style="border: 1px solid black; text-align: center;">EMAIL</th>
		<th style="border: 1px solid black; text-align: center;">PHONE</th>
